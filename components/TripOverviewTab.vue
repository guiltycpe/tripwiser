  ...
  <div class="w-full h-full overflow-y-auto p-8 space-y-6 animate-fade-in">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
      ...
      <div class="lg:col-span-1 space-y-6 flex flex-col">
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-shadow flex-1 flex flex-col">
          ...
          <div class="p-4 space-y-3 flex-1 flex flex-col">
            <div class="flex gap-2">
              <div class="flex-1 bg-teal-50 dark:bg-teal-900/30 rounded-lg p-2.5 text-center border border-teal-100 dark:border-teal-800">
              ...
              <div class="flex-1 bg-blue-50 dark:bg-blue-900/30 rounded-lg p-2.5 text-center border border-blue-100 dark:border-blue-800">
            ...
            <div class="space-y-2.5 pt-2 border-t border-gray-100 dark:border-gray-700 flex-1">
              <div class="flex items-center justify-between text-sm">
                ...
                <span class="font-bold text-gray-900 dark:text-gray-100">${{ tripData.trip_summary.cost_breakdown?.accommodation_total || 0 }}</span>
              </div>
              ...
              <div class="flex items-center justify-between text-sm">
                ...
                <span class="font-bold text-gray-900 dark:text-gray-100">${{ tripData.trip_summary.cost_breakdown?.food_total || 0 }}</span>
              </div>
              <div class="w-full bg-gray-100 dark:bg-slate-700 rounded-full h-1.5">
              ...
              <div class="flex items-center justify-between text-sm">
                ...
                <span class="font-bold text-gray-900 dark:text-gray-100">${{ tripData.trip_summary.cost_breakdown?.activities_total || 0 }}</span>
              </div>
              <div class="w-full bg-gray-100 dark:bg-slate-700 rounded-full h-1.5">
      ...
      <div class="lg:col-span-2 space-y-6">
        <!-- Flights -->
        <div v-if="tripData.transport" class="bg-gradient-to-br from-blue-50 dark:from-blue-900/30 to-indigo-50 dark:to-indigo-900/30 rounded-2xl border border-blue-200 dark:border-blue-800 overflow-hidden">
          <div class="p-5">
            ...
            <div class="grid md:grid-cols-2 gap-4">
              <a :href="tripData.transport.outbound_flight.kayak_link || tripData.transport.outbound_flight.google_flights_link || tripData.transport.outbound_flight.skyscanner_link" target="_blank" class="group/flight bg-white dark:bg-slate-900 rounded-xl p-4 hover:shadow-md transition-all border border-blue-100 dark:border-blue-800 hover:border-blue-300 dark:hover:border-blue-600">
                <div class="flex items-center gap-3">
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="font-bold text-gray-900 dark:text-gray-100 truncate">{{ formatDestination(tripData.trip_summary.destination) }}</p>
                    <p class="text-xs text-gray-600 dark:text-gray-400 font-medium">{{ tripData.transport.outbound_flight.departure_date }}</p>
                  </div>
                </div>
              </a>
              
              <a :href="tripData.transport.return_flight.kayak_link || tripData.transport.return_flight.google_flights_link || tripData.transport.return_flight.skyscanner_link" target="_blank" class="group/flight bg-white dark:bg-slate-900 rounded-xl p-4 hover:shadow-md transition-all border border-indigo-100 dark:border-indigo-800 hover:border-indigo-300 dark:hover:border-indigo-600">
                <div class="flex items-center gap-3">
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="font-bold text-gray-900 dark:text-gray-100 truncate">{{ t.tripDetails.overview.returnFlight }}</p>
                    <p class="text-xs text-gray-600 dark:text-gray-400 font-medium">{{ tripData.transport.return_flight.return_date }}</p>
                  </div>
                </div>
              </a>
            </div>
        ...
        <!-- Accommodation -->
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div class="p-5">
            <h3 class="text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider mb-3 flex items-center gap-2">
              <Icon name="heroicons:home-modern-20-solid" class="h-4 w-4 text-purple-600" />
              {{ t.tripDetails.overview.whereToSleep }}
            </h3>
            
            <div class="mb-4 p-3 bg-gradient-to-r from-teal-50 dark:from-teal-900/30 to-cyan-50 dark:to-cyan-900/30 rounded-lg border-l-4 border-teal-500">
            ...
            <div class="grid md:grid-cols-2 gap-3">
              <a v-for="(base, idx) in tripData.accommodation_strategy?.bases" :key="idx" :href="base.booking_link" target="_blank" class="block p-4 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-teal-400 transition-all bg-gray-50 dark:bg-gray-800 hover:bg-white dark:hover:bg-slate-900 hover:shadow-md group/base cursor-pointer">
                <div class="flex items-start justify-between mb-2">
                  <h4 class="font-bold text-gray-900 dark:text-gray-100 group-hover/base:text-teal-600 transition-colors">{{ base.neighborhood }}</h4>
                  <Icon name="heroicons:arrow-top-right-on-square-20-solid" class="h-4 w-4 text-gray-400 dark:text-gray-500 group-hover/base:text-teal-500 transition-colors flex-shrink-0" />
                </div>
                ...
                <p class="text-xs text-gray-600 dark:text-gray-400 leading-relaxed line-clamp-2">{{ base.why_here }}</p>
              </a>
            </div>
          </div>
        </div>
