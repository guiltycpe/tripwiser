    ...
    <div class="w-full max-w-md">
      <div class="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm animate-fade-in">
        <div class="text-center mb-8">
          ...
          <p class="text-slate-500 mt-2 text-sm">{{ t.auth.login.subtitle }}</p>
        </div>
        ...
        <form @submit.prevent="handleLogin" class="space-y-5">
          <div>
            <label for="email" class="block text-sm font-medium text-slate-700 mb-1.5">{{ t.auth.login.email }}</label>
            <input
          ...
          <div>
            <label for="password" class="block text-sm font-medium text-slate-700 mb-1.5">{{ t.auth.login.password }}</label>
            <input
          ...
          <div class="flex items-center justify-between text-sm">
            <label class="flex items-center">
              ...
              <span class="ml-2 text-slate-600">{{ t.auth.login.rememberMe }}</span>
            </label>
